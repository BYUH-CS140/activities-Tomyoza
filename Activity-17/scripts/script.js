document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    var phoneValid = /^\+?(\d{1,3})?[-.\s]?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}$/;
    ...
    document.getElementById('phoneFeedback').textContent = phoneValid ? '' : 'Please enter a valid phone number (e.g., +1-555-123-4567, 555-123-4567, or (555) 123-4567).'
    ...
    var formValid = usernameValid && phoneValid && emailValid && passwordValid;
